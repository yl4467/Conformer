...
class Dataset_ETT_minute(Dataset):
    ...
    def __read_data__(self):
        ...
        border1s = [0, 12*30*24*4 - self.seq_len, 12*30*24*4+1*30*24*4 - self.seq_len]
...
class Dataset_elec(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.data_set == 'elec': #12/2/2
            ...
            border1s = [0, 12*30*24 - self.seq_len, 12*30*24+2*30*24 - self.seq_len]
...
class Dataset_airdelay(Dataset):
    ...
    def __read_data__(self):
        ...
        if self.scale:
            ...
            data = df_data.values
        df_raw['arrTime'] = pd.DataFrame((df_raw['arrTime'].apply(int)).apply(str).str.zfill(4))
